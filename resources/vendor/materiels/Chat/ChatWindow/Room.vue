      ...
      <div class="messages-container">
        <div :class="{ 'messages-hidden': loadingMessages }">
          <transition name="fade-message">
            <div class="text-started" v-if="showNoMessages">{{ textMessages.MESSAGES_EMPTY }}</div>
            <div
              class="text-started"
              v-if="showMessagesStarted"
            >{{ textMessages.CONVERSATION_STARTED }} {{ messages[0].date }}</div>
          </transition>
          <transition name="fade-message">
            <infinite-loading
    ...
    <div ref="roomFooter" class="room-footer" v-if="Object.keys(room).length">
      ...
      <div class="box-footer">
        ...
        <div class="icon-textarea">
          <div class="svg-button" v-if="editedMessage.id" @click="resetMessage">
            <svg-icon name="close-outline" />
          </div>
          ...
          <div @click="sendMessage" class="svg-button" :class="{ 'send-disabled': inputDisabled }">
